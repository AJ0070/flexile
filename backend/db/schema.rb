...
ActiveRecord::Schema[8.0].define(version: 2025_07_27_063800) do
  ...
  create_table "dividend_rounds", force: :cascade do |t|
    ...
    t.integer "processing_fee_in_cents"
    ...
    t.index ["stripe_charge_id"], name: "index_dividend_rounds_on_stripe_charge_id", unique: true
  end
  ...
  create_table "dividends", force: :cascade do |t|
    ...
    t.string "wise_quote_id"
    t.decimal "transfer_fee_in_usd", precision: 10, scale: 2
    ...
    t.index ["payment_method"], name: "index_dividends_on_payment_method"
    t.index ["stripe_transfer_id"], name: "index_dividends_on_stripe_transfer_id", unique: true
    t.index ["user_compliance_info_id"], name: "index_dividends_on_user_compliance_info_id"
    t.index ["wise_quote_id"], name: "index_dividends_on_wise_quote_id"
    t.index ["wise_transfer_id"], name: "index_dividends_on_wise_transfer_id", unique: true
  end
